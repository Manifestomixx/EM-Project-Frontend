...
import { regFormSchema } from "../utility/ValidationSchema";
...
const SignUp = () => {
  ...
  } = useForm({resolver:yupResolver(regFormSchema),
    defaultValues:{
      userName:"",
      email:"",
      password:"",
  ...
  const onSubmit = async(data) => {
    ...
    try {
      setSuccessMsg("");
      setServerError("")
      const req = await fetch("https://em-project-backend-tur2.onrender.com/api/v1/auth/register",{
        method:"POST",
        headers:{
          ...
          <div className="bg-white m-auto p-5 col-md-6">
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Form.Group className="mb-3 position-relative" controlId="formGroupEmail">
                ...
                <Form.Control type="email"  placeholder="Email" className="bg-light shift"
              ...
              <Form.Group className="mb-3 position-relative" controlId="formGroupUsername">
              <div className="position-relative">
                <Form.Control type="text"  placeholder="Username" 
                className="bg-light shift"
            ...
            <p className="text-secondary ptag1 text-center">By signing up you accept our Privacy Policy, Terms & Licensing Agreement. Protected by reCAPTCHA. Google Privacy Policy & Terms apply.</p>
